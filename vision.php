        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item p-4">
                    ...
                    <p><strong>L'Assemblée Générale (AG),</strong> est l'organe suprême de décision, qui se réunit annuellement pour définir la politique générale et élire les membres du Bureau Exécutif National (B.E.N).</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item p-4">
