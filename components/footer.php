    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>opeeciopeeci@gmail.com</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="index.php#activite">Soutien Scolaire</a>
                <a class="btn btn-link" href="index.php#activite">Conférences et Ateliers</a>
                <a class="btn btn-link" href="index.php#activite">Événements</a>
                <a class="btn btn-link" href="index.php#activite">Solutions Communautaires</a>
                <a class="btn btn-link" href="index.php#activite">Partenariats</a>
            </div>
            <div class="col-lg-3 col-md-6">
                <h4 class="text-light mb-4">Liens Utiles</h4>
                <a class="btn btn-link" href="vision.php">À propos de nous</a>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="position-relative mx-auto" style="max-width: 400px;">
                    <input class="form-control border-0 w-100 py-3 ps-4 pe-5" type="email" placeholder="Votre email">
        ...
        <div class="copyright">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-end">
                    ...
                    Conçu par <a class="border-bottom" href="https://www.linkedin.com/in/ismael-aziz-bakayoko-2b415a222/">Ismael Bakayoko</a>
                </div>
            </div>
        </div>
    </div>
